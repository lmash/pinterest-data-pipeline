...
def test_stream_get_post_delete():
    """Test streams/stream-name GET gateway API"""
    invoke_url = "https://jydbc247f4.execute-api.us-east-1.amazonaws.com/Prod/streams/<stream_name>/"
...
def test_records_api():
    ...
    example_df = {"index": 1, "name": "Maya", "age": 25, "role": "engineer"}
    invoke_url = "https://jydbc247f4.execute-api.us-east-1.amazonaws.com/Prod/streams/<stream_name>/records"
